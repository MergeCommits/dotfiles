...

{
    ...
    rules: [
        ...
        k.ruleSwapControlModifierToCommand('1'),
        k.ruleSwapControlModifierToCommand('2'),
        k.ruleSwapControlModifierToCommand('3'),
        k.ruleSwapControlModifierToCommand('4'),
        k.ruleSwapControlModifierToCommand('5'),
        k.ruleSwapControlModifierToCommand('6'),
        k.ruleSwapControlModifierToCommand('7'),
        k.ruleSwapControlModifierToCommand('8'),
        k.ruleSwapControlModifierToCommand('9'),
        k.ruleSwapControlModifierToCommand('0'),
        k.ruleSwapControlModifierToCommand('hyphen'),
        k.ruleSwapControlModifierToCommand('equal_sign'),
        k.ruleSwapControlModifierToCommand('open_bracket'),
        k.ruleSwapControlModifierToCommand('close_bracket'),
        k.ruleSwapControlModifierToCommand('semicolon'),
        k.ruleSwapControlModifierToCommand('quote'),
        k.ruleSwapControlModifierToCommand('comma'),
        k.ruleSwapControlModifierToCommand('period'),
        k.ruleSwapControlModifierToCommand('slash'),
        k.ruleSwapControlModifierToCommand('grave_accent_and_tilde'),
